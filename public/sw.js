var cacheName = "cache-0-2-0";
var apiCacheName = 'apicache-0-1-1';
var cacheFiles = [
    '/',
    './index.html',
    './style.css',
...
self.addEventListener('installing', function () { 
    ...
    e.waitUntil(
        ...
        self.clients.matchAll().then(function (clients) {
            if (!clients || clients.length === 0) {
                // 在网站关闭时打开该网站
                self.clients.openWindow && self.clients.openWindow('http://127.0.0.1:8084');
                return;
            }
...
self.addEventListener('sync', function (e) {
    ...
    if (e.tag === 'sample_sync') {
        ...
        let msgPromise = new Promise(function (reslove, reject) {
            // 监听message事件中触发的事件通知
